...
namespace DatabaseTest.RealtimeModuleTest
{
    public static class Helpers
    {
        ...
        {
            return RestfulFirebase.UnitTest.Helpers.AuthenticatedTestApp(nameof(RealtimeModuleTest), testName, factName);
        }
        ...
        {
            return RestfulFirebase.UnitTest.Helpers.CleanTest(nameof(RealtimeModuleTest), testName, factName, test);
        }
...
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
    ...
    public class DataChangesTest
    {
        ...
        public async void Normal()
        {
            await Helpers.CleanTest(nameof(DataChangesTest), nameof(Normal), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(appInstance1.wire));
    ...
    public class ErrorTest
    {
        ...
        public async void Normal()
        {
            var (generator, dispose) = await RestfulFirebase.UnitTest.Helpers.AuthenticatedAppGenerator();
    ...
    public class GetDataCountTest
    {
        ...
        public async void Normal()
        {
            await Helpers.CleanTest(nameof(GetDataCountTest), nameof(Normal), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(appInstance3.wire));
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(appInstance4.wire));
