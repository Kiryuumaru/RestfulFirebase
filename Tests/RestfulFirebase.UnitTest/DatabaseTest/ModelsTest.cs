...
namespace DatabaseTest.ModelsTest
{
    public static class Helpers
    {
        ...
        {
            return RestfulFirebase.UnitTest.Helpers.AuthenticatedTestApp(nameof(ModelsTest), testName, factName);
        }
        ...
        {
            return RestfulFirebase.UnitTest.Helpers.CleanTest(nameof(ModelsTest), testName, factName, test);
        }
    ...
    public class FirebasePropertyTest
    {
        ...
        public async void Normal()
        {
            await Helpers.CleanTest(nameof(FirebasePropertyTest), nameof(Normal), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(model1.RealtimeInstance));
        ...
        public async void PutOverwrite()
        {
            await Helpers.CleanTest(nameof(FirebasePropertyTest), nameof(PutOverwrite), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(wire));

                appInstance2.wire.PutModel(model2);

                appInstance2.app.Config.RealtimeDatabaseMaxConcurrentSyncWrites = 10;
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(appInstance2.wire));
        ...
        public async void CrossSync()
        {
            await Helpers.CleanTest(nameof(FirebasePropertyTest), nameof(CrossSync), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(model2.RealtimeInstance));
                await Task.Delay(5000);
    ...
    public class FirebaseObjectTest
    {
        ...
        public async void Nullable()
        {
            await Helpers.CleanTest(nameof(FirebaseObjectTest), nameof(Nullable), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(person1.RealtimeInstance));
        ...
        public async void CrossSync()
        {
            await Helpers.CleanTest(nameof(FirebaseObjectTest), nameof(CrossSync), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(person2.RealtimeInstance));
                await Task.Delay(5000);
    ...
    public class FirebaseDictionaryTest
    {
        ...
        public async void Nullable()
        {
            await Helpers.CleanTest(nameof(FirebaseDictionaryTest), nameof(Nullable), async generator =>
            {
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(dictionary1.RealtimeInstance));
                ...
                Assert.True(await RestfulFirebase.UnitTest.Helpers.WaitForSynced(dictionary2.RealtimeInstance));
