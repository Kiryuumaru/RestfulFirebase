...
public class OrderQuery
{
    ...
    public class Builder
    {
        ...
        /// </exception>
        public Builder Ascending(Type objType, params string[] namePath)
        {
            orderQuery.Add(new(objType, namePath, Direction.Ascending, null, null));
            return this;
        }
        ...
        /// <paramref name="namePath"/> is a null reference.
        /// </exception>
        public Builder Descending(Type objType, params string[] namePath)
        {
            orderQuery.Add(new(objType, namePath, Direction.Descending, null, null));
            return this;
        }
        ...
        /// The <see cref="Builder"/> with new added query.
        /// </returns>
        public Builder AscendingDocumentName(Type objType)
        {
            orderQuery.Add(new(objType, new string[] { DocumentFieldHelpers.DocumentName }, Direction.Ascending, null, null));
            return this;
        }
        ...
        /// The <see cref="Builder"/> with new added query.
        /// </returns>
        public Builder DescendingDocumentName(Type objType)
        {
            orderQuery.Add(new(objType, new string[] { DocumentFieldHelpers.DocumentName }, Direction.Descending, null, null));
            return this;
        }
    ...
    internal OrderQuery(Type modelType, string[] namePath, Direction direction, object? startPosition, object? endPosition)
    {
