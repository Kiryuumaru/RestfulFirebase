namespace RestfulFirebase.Database.Offline
{
    ...
    internal class OfflineCacheAdapter<TKey, T> : IDictionary<string, T>, IDictionary 
    {
        ...
        object IDictionary.this[object key]
        {
            get
            {
                return database[key.ToString()].Deserialize<T>();
            }
            ...
            set
            {
                ...
                {
                    database[keyString] = new OfflineEntry(keyString, value, database[keyString].Priority, database[keyString].SyncOptions);
                }
                else
                {
        ...
        public T this[string key]
        {
            get
            {
                return database[key].Deserialize<T>();
            }
