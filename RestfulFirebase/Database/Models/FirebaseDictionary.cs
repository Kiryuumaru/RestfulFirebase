...
/// <summary>
/// Provides an observable model <see cref="ObservableDictionary{TKey, TValue}"/> for the <see cref="Realtime.RealtimeInstance"/>.
/// </summary>
/// <typeparam name="T">
...
public class FirebaseDictionary<T> : ObservableDictionary<string, T>, IInternalRealtimeModel
{
    ...
    protected void WireValue(RealtimeInstance instance, string key, object? value, bool invokeSetFirst)
    {
        ...
        {
            instance.Child(key).SetValue(Serializer.Serialize(obj));
        }
    }
