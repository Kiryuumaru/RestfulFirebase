...
/// <summary>
/// A container for all shared <see cref="AppContext"/> configuration switches for the ObservableHelpers.
/// </summary>
internal static class Configuration
{
    ...
    /// </summary>
    private const string DisableINotifyPropertyChangingSupport = "OBSERVABLEHELPERS_DISABLE_INOTIFYPROPERTYCHANGING";
