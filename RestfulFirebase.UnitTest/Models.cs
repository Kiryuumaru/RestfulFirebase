...
public class AllType
{
    ...
    public static AllType Empty(FirebaseApp app)
    {
        return new AllType()
        {
            NullValue1 = null,
            ...
            ReferenceValue1 = app.FirestoreDatabase.Collection("a").Document("b"),
            ReferenceValue1Null = app.FirestoreDatabase.Collection("a").Document("b"),
            ReferenceValue2Null = app.FirestoreDatabase.Collection("a").Document("b"),
    ...
    public static AllType Filled1(FirebaseApp app)
    {
        return new AllType()
        {
            NullValue1 = null,
    ...
    public static AllType Filled2(FirebaseApp app)
    {
        return new AllType()
        {
            NullValue1 = null,
...
public class NestedType
{
    ...
    public static NestedType Empty(FirebaseApp app)
    {
        return new NestedType()
        {
            AllType1 = AllType.Empty(app),
    ...
    public static NestedType Filled1(FirebaseApp app)
    {
        return new NestedType()
        {
            AllType1 = AllType.Filled1(app),
            ...
            DictionaryAllType1 = new Dictionary<string, AllType>()
            {
                { "allTypeKey1",  AllType.Filled1(app) },
                { "allTypeKey2",  AllType.Empty(app) },
                { "allTypeKey3",  AllType.Filled2(app) },
            },
            DictionaryAllType2 = new Dictionary<string, AllType?>()
            {
                { "allTypeKey11",  AllType.Filled2(app) },
                { "allTypeKey22",  AllType.Filled1(app) },
                { "allTypeKey33",  AllType.Empty(app) },
            },
            DictionaryAllType3 = new Dictionary<int, AllType?>()
            {
                { 1,  AllType.Empty(app) },
                { 2,  AllType.Filled1(app) },
                { 3,  AllType.Filled2(app) },
            }
        };
    }

    public static NestedType Filled2(FirebaseApp app)
    {
        return new NestedType()
        {
            AllType1 = AllType.Filled2(app),
            ArrayAllType1 = new AllType[3]
            {
                AllType.Filled2(app),
                AllType.Filled1(app),
            ...
            DictionaryAllType1 = new Dictionary<string, AllType>()
            {
                { "allTypeKey1",  AllType.Filled2(app) },
                { "allTypeKey2",  AllType.Empty(app) },
                { "allTypeKey3",  AllType.Filled1(app) }
            },
            DictionaryAllType2 = new Dictionary<string, AllType?>()
            {
                { "allTypeKey11",  AllType.Empty(app) },
                { "allTypeKey22",  AllType.Filled1(app) },
                { "allTypeKey33",  AllType.Filled2(app) }
            },
            DictionaryAllType3 = new Dictionary<int, AllType?>()
            {
                { 1,  AllType.Filled2(app) },
                { 2,  AllType.Filled1(app) },
                { 3,  AllType.Empty(app) },
            }
        };
