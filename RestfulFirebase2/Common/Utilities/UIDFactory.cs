...
{
    private static readonly char[] PushChars = Encoding.UTF8.GetChars(Encoding.UTF8.GetBytes(StringSerializer.Base64Charset));
    ...
    /// </param>
    /// <returns></returns>
    public static string GenerateUID(int length = 10, string charset = StringSerializer.Base64Charset)
    {
        string id = "";
